...
/**
  ReactApp is the main class Ember CLI uses to manage the Brocolli trees
...
ReactApp.prototype = Object.create(EmberApp.prototype);
ReactApp.prototype.constructor = ReactApp;
ReactApp.prototype.appConstructor = EmberApp.prototype.constructor;

ReactApp.prototype._contentForAppBoot = function _contentForAppBoot(content, config) {
